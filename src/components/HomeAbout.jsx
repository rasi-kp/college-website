...
const HomeAbout = () => {
  return (
    <div className="flex lg:flex-row sm:flex-col md:flex-col xs:flex-col bg-cyan-50" >
      <section className='img-abt p-10 pl-20 md:pl-[72px] flex flex-row gap-7 md:justify-around  '>
        <div className="img-cont1 overflow-hidden h-[500px]   border-4 rounded-3xl w-[300px]   border-red-400  ">
            <img src={ aboutfir } className='w-full h-full object-cover overflow-hidden' />
        </div>
        <div className="img-cont2 overflow-hidden h-[500px] border-4 rounded-3xl lg:mt-40 md:mt-0 w-[300px]  border-sky-800  ">
